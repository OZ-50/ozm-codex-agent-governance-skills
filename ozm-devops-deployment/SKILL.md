---
name: ozm-devops-deployment
description: Use for OZM-managed deployment, release, rollback, environment promotion, infrastructure command, CI/CD, or runtime rollout work.
---
...
| Field | Contract |
| --- | --- |
| Applicability | OZM-governed deployment, release, rollback, environment promotion, infrastructure command, CI/CD, or runtime rollout work. |
...
| Output receipt | `deployment_proof_matrix`, `external_prerequisite_table`, and `rollback_recovery_plan`. |
...
activation_effect_contract:
  owner_question:
    - "What domain proof, prerequisite, negative test, and rollback/recovery evidence is required before this devops deployment claim can rise?"
  blocks_when:
  ...
  non_surface_failure_code:
    - ozm-devops-deployment_loaded_without_required_activation_effect
```
